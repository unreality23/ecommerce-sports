    ...
    return (
        <>
            <div className="flex items-center">
                <button
                    className="border-0 bg-transparent px-2 text-xl leading-none transition-shadow duration-150
                        ease-in-out hover:text-pink-300 focus:text-pink-300 dark:hover:text-pink-300
            ...
            <div className={`${!isActive && 'hidden'} !visible grow basis-[100%] items-center lg:!flex lg:basis-auto`}
